      ...
      data() {
        return {    
          ...
          roomDetails: {
            ...
            "GRAND_SUITE": {
                basicInfo: "그랜드 스위트룸은 45m²의 인상적인 면적을 차지하며 별도의 거실과 침실 공간을 갖추고 있습니다. 이 스위트룸은 우아한 장식과 레저 및 비즈니스 여행객 모두를 만족시키는 현대적인 편의 시설을 갖추고 있어 여유로운 공간과 고급스러움을 원하는 고객에게 적합합니다.",
                amenities: "풀서비스 주방, 대형 평면 TV, 무료 초고속 인터넷, 전용 자쿠지, 프리미엄 침구와 고급 가구"
            },
            "ROYAL_SUITE": {
                basicInfo: "로열 스위트룸은 45m²가 넘는 공간에서 장엄한 경험을 제공하며, 비교할 수 없는 럭셔리함과 프라이버시를 제공하도록 설계된 별도의 생활 공간과 침실 공간을 갖추고 있습니다. 이 스위트룸은 고급 가구와 예술 작품으로 장식되어 있어 고급스럽고 우아한 분위기를 연출합니다.",
                amenities: "최첨단 주방 시설, 대형 울트라 HD TV, 고급 고속 인터넷 연결, 탁 트인 전망을 감상할 수 있는 객실 내 자쿠지, 자연광이 들어오는 천장부터 바닥까지 내려오는 대형 창문을 통한 뛰어난 전망"
            },
            "FLINT_SUITE": {
                basicInfo: "럭셔리의 정점인 플린트 스위트는 45m² 규모로 독특한 가구와 고급 예술품으로 세심하게 디자인되었습니다. 이 스위트룸은 세심하게 분리된 거실과 침실 공간을 갖춘 세련된 안식처를 제공하며 비교할 수 없는 고급스러움과 맞춤 서비스를 제공합니다.",
