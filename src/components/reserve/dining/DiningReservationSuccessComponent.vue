                ...
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    ...
                    <v-row>
                      ...
                      <v-col cols="12" md="10">
                        <v-text-field v-model="diningName" outlined readonly></v-text-field>
                      </v-col>
                    </v-row>
                    <v-row>
                      <v-col cols="12" md="2">
                      ...
                      <v-col cols="12" md="10">
                        <v-text-field :value="`성인 : ${adult}명    아이 : ${child}명`" outlined readonly></v-text-field>
                      </v-col>
                    </v-row>
                    <v-row>
                      <v-col cols="12" md="2">
                      ...
                      <v-col cols="12" md="10">
                        <v-text-field :value="`날짜 : ${reservationDate}    시간 : ${reservationTime}`" outlined
